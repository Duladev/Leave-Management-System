        ...
        static async initialize(userId) {
            ...
            try {
                ...
                for (const leaveType of leaveTypes.recordset) {
                    ...
                    .input('total_days', sql.Decimal(5, 1), 0.0)
                    .input('used_days', sql.Decimal(5, 1), 0.0)
                    .input('available_days', sql.Decimal(5, 1), 0.0)
                    .input('year', sql.Int, year)
                    .query(`
                ...
                `);
                            ...
                            static async updateBalanceManually(balanceId, balanceData) {
                                ...
                                try {
                                    ...
                                    //If remove following comment, it can be use for edit used leaved count for the HR
